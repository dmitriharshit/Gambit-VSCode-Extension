...
exports.createLogFile = void 0;
const fs = require('fs');
// const jsonfile = require('jsonfile');
const path = require('path');
const os = require('os');
function createLogFile(inputfilepath, outFilePath) {
    var cFile = '';
    ...
    return new Promise(resolve => {
        fs.readFile(inputfilepath, 'utf8', (err, loggingFileData) => {
            ...
            for (const obj of jsonObjects) {
                ...
                if (obj.includes('command": "continue"') && obj.includes('type": "request"')) {
                    commandsString += "c";
                }
                //check cFile path
...
//# sourceMappingURL=create_logfile.js.map